...
image: breach.png
---
>​Breach CTF is a 24-hour online Jeopardy-style Capture The Flag (CTF) competition hosted by IITBreachers, the CTF team of the Cyber Security Community at IIT Bombay. The event is organized by CSeC IITB, a group of enthusiasts who actively participate in CTF competitions with the mission to make cybersecurity accessible and engaging for everyone at the institute. ​
...
1. Instead of checking `inp % b[i] == 0`, we check `inp % a[i] == 0`
...
#### Code Analysis
`chall.sage.py`:
1. Uses a custom NTRU-like scheme over the ring
![](raaa.png)
...
change the flag format with Breach{},
...
>this web chall ofc need to graphQL injection to solve, so i start with scheme
